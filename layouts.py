...
def generate_figure(dataframe,dataframe2, graph_type):
    if graph_type == 'Line Chart':
        ...
        fig = px.line(dataframe, x='Date', y='Culture', color='REGION', title='Sales Over Time')
    elif graph_type == 'Map':
...
home_layout = dbc.Container([
    ...
    html.Br(),
    html.H1('RISO DATA - SENEGAL', className='mb-4 text-light'),  # Adding a title for the home page

    html.Div([
        
        html.P('Welcome to RISO DATA - SENEGAL, your gateway to agricultural insights in Senegal.'),
...
regional_layout = dbc.Container([
    html.Br(),
    html.H1('RISO DATA - REGIONAL', className='mb-4 text-light', id="Header_text"),  # Adding a title for the home page

    html.Div([
        
        html.P('Welcome to RISO DATA - REGIONAL, your gateway to agricultural insights in Senegal.', id="Subheader_text"),
        html.P('Explore the data visualizations below to gain valuable insights into the agricultural landscape of Senegal.'),
        #html.Img(src='/assets/senegal_map.jpg', alt='Senegal Map', style={'width': '100%', 'height': 'auto', 'margin-top': '20px'})
    ], className='mb-4'),  # Adding a div for information and an image of Senegal
...
district_layout = dbc.Container([
    html.Br(),
    html.H1('RISO DATA - DISTRICT', className='mb-4 text-light'),  # Adding a title for the home page

    html.Div([
        
        html.P('Welcome to RISO DATA - DISTRICT, your gateway to agricultural insights in Senegal.'),
        html.P('Explore the data visualizations below to gain valuable insights into the agricultural landscape of Senegal.'),
        #html.Img(src='/assets/senegal_map.jpg', alt='Senegal Map', style={'width': '100%', 'height': 'auto', 'margin-top': '20px'})
    ], className='mb-4'),  # Adding a div for information and an image of Senegal
