...
#TODO:
# 1. Upload Data to s3
# 2. Connect data to s3
# 3. Connect graph to webApp
# 4. Convert PDF to graph
# 5. Convert all data to graph data
# 6. Re-engineer Site with graph data
# 7. Improve Functionality of data considerably
# 8. Add all Jaures improvements
...
navbar = dbc.Navbar(
    dbc.Container(
        [
            dbc.NavbarBrand("DATA", href="/", className="me-auto"),
